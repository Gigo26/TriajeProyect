...
class RecomendacionAdapter : ListAdapter<Recomendacion, RecomendacionAdapter.ViewHolder>(DiffCallback) {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val tvStepTitle: TextView = view.findViewById(R.id.tvStepTitle)
        private val tvStepDescription: TextView = view.findViewById(R.id.tvStepDescription)
        private val ivStepIcon: ImageView = view.findViewById(R.id.ivStepIcon)
